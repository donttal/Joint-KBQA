'''
@Author: Hong Jing Li
@Date: 2020-01-12 17:56:23
@LastEditors  : Hong Jing Li
@LastEditTime : 2020-02-11 14:47:49
    ...
    with open(file_path, 'r', encoding='utf-8') as f:
        ...
        for line in f:
            if line.startswith('<question'):
                sample['question'] = line.strip().split(
                    '\t')[1].strip().lower()
...
if __name__ == "__main__":
    train_data = load_data('../QAdata/nlpcc-iccpol-2016.kbqa.training-data')
    s2p = load_knowledge()
    ...
    with open('../QAdata/train.json', 'w', encoding='utf-8') as f:
        for sample in train_data:
            f.write(json.dumps(sample, ensure_ascii=False) + '\n')

    test_data = load_data('../QAdata/nlpcc-iccpol-2016.kbqa.testing-data')
    with open('../QAdata/dev.json', 'w', encoding='utf-8') as f:
